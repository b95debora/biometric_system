...
pickle_out = open("x_training_race.pickle","wb")
pickle.dump(x_train, pickle_out)
pickle_out.close()

pickle_out = open("y_training_race.pickle","wb")
pickle.dump(y_train, pickle_out)
pickle_out.close()

pickle_out = open("x_validation_race.pickle","wb")
pickle.dump(x_validation, pickle_out)
pickle_out.close()

pickle_out = open("y_validation_race.pickle","wb")
