...
image = cv2.imread('C:/Users/Davide Soldani/Desktop/index.jpeg' ,cv2.IMREAD_COLOR)  # convert to array #IMREAD_COLOR #IMREAD_GRAYSCALE
image = cv2.resize(image, (714, 663)) 
